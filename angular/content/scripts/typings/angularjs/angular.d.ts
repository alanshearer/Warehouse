...
declare module angular {
    ...
    interface IModule {
        ...
        /**
         * Use this method to register work which needs to be performed on module loadi angular.
         *
    ...
    interface IFilterDate {
         ...
         * @param timezone Timezone to be used for formatti angular. It understands UTC/GMT and the continental US time zone abbreviations, but for general use, use a time zone offset, for example, '+0430' (4 hours, 30 minutes east of the Greenwich meridian) If not specified, the timezone of the browser will be used.
    ...
    interface IFilterJson {
        /**
         * Allows you to convert a JavaScript object into JSON stri angular.
         * @param object Any JavaScript object (including arrays and primitive types) to filter.
         * @param spacing The number of spaces to use per indentation, defaults to 2.
         * @return JSON stri angular.
         */
    ...
    interface IFilterLimitTo {
        ...
        /**
         * Creates a new string containing only a specified number of elements. The elements are taken from either the beginning or the end of the source string or number, as specified by the value and sign (positive or negative) of limit. If a number is used as input, it is converted to a stri angular.
         * @param input Source string or number to be limited.
         * @param limit The length of the returned stri angular. If the limit number is positive, limit number of items from the beginning of the source string are copied. If the number is negative, limit number of items from the end of the source string are copied. The limit will be trimmed if it exceeds input.length. If limit is undefined, the input will be returned unchanged.
         * @param begin Index at which to begin limitation. As a negative index, begin indicates an offset from the end of input. Defaults to 0.
    ...
    interface ILocationService {
         ...
         * Note: Path should always begin with forward slash (/), this method will add the forward slash if it is missi angular.
         *
         * @param path New path
         */
    ...
    */
    interface IHttpProviderDefaults {
        /**
         * {boolean|Cache}
         * If true, a default $http cache will be used to cache the GET request, otherwise if a cache instance built with $cacheFactory, this cache will be used for cachi angular.
         */
        cache?: any;
    ...
    interface IHttpProvider extends IServiceProvider {
         ...
         * @returns {boolean|Object} If a value is specified, returns the $httpProvider for chaini angular.
    ...
    export module auto {
        ...
        interface IProvideService {
            ...
            // implementation does not return anythi angular.
